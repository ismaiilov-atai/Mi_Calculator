...
class AreaUnitDialog(private var viewGroup: ViewGroup) : BaseDialog<CustomUnitDialogBinding,AreaUnitViewModel>(CustomUnitDialogBinding::inflate,AreaUnitViewModel::class.java) {
